using APPHDotNetCore.NLayer.DataAccess.Db;
using APPHDotNetCore.NLayer.DataAccess.Models;

namespace APPHDotNetCore.NLayer.DataAccess.Services
{
    //DataAccess
    public class DA_Blog
    {
        ...
        public int UpdateBlog(int id, BlogModel requstModel)
        {
            ...
            item.BlogTitle = requstModel.BlogTitle;
            item.BlogAuthor = requstModel.BlogAuthor;
            item.BlogContent = requstModel.BlogContent;
